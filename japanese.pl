...
word(
    ...
    word       => '引数',
    furigana   => 'ひきすう',
    english    => 'parameters (to a function)',
);
...
word(
    ...
    word       => '停電',
    furigana   => 'ていでん',
    english    => 'power failure; blackout',
);
